...
<footer id="footer" class="footer divider layer-overlay overlay-dark-9"
      ...
      <div class="col-sm-6 col-md-4">
        <div class="widget dark">
          ...
          <div class="opening-hours">
            <ul>
              <li class="clearfix text-white"> <span> Monday - Friday : </span>
                <div class="value pull-right"> 8.00 am - 5.00 pm </div>
              </li>
              <li class="clearfix text-white"> <span> Weekend : </span>
                <div class="value pull-right"> Closed </div>
              </li>
              <li class="clearfix text-white"> <span> Public holidays : </span>
                <div class="value pull-right"> Closed </div>
              </li>
            </ul>
  ...
  <div class="footer-bottom bg-black-333" id="m-footer-top">
  ...
  <div class="footer-bottom bg-black-333" id="m-footer" style="display: none;">
    <div class="container pt-20 pb-20">
      <div class="row">
        <div class="col-md-12">
        </div>
