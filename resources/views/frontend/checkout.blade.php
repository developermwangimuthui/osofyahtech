            ...
            <form id="checkout-form" action="#">
              ...
              <div class="col-md-12">
                ...
                <table class="table table-striped table-bordered tbl-shopping-cart">
                  ...
                  <tbody>
                    <tr>
                      <td class="product-thumbnail"><a href="#"><img alt="member" src="/front/images/products/4.jpg"></a></td>
                      <td><a href="#">Helmets</a> x 2</td>
                      <td><span class="amount">$36.00</span></td>
                    </tr>
                    <tr>
                      <td class="product-thumbnail"><a href="#"><img alt="member" src="/front/images/products/3.jpg"></a></td>
                      <td><a href="#">Saddles</a> x 3</td>
                      <td><span class="amount">$115.00</span></td>
                    </tr>
                    <tr>
                      <td class="product-thumbnail"><a href="#"><img alt="member" src="/front/images/products/7.jpg"></a></td>
